//https://github.com/CJLST/ZZAnalysis/blob/0358939f858a1744c25265127487ad152ce9b956/AnalysisStep/src/Category.cc
#include <Category.h>
...
int categoryIchep16_noextern(
    ...
    bool dodelete = false;
    float *jetQGLikelihood = new float[nCleanedJetsPt30];
